...
func (s *server) itemService() {
	...
	item.PATCH("/item/:item_id/toggle-status", s.mid.JwtAuthorization(s.mid.RbacAuthorization(httpHandler.ToggleItemUsageStatus, []int{1, 0}))) // Toggle Item Usage Status
}
