...
func (x *IsAvailableToSellReq) GetItemId() int32 {
	if x != nil {
		return x.ItemId
	}
	return 0
...
const file_modules_inventory_inventoryPb_inventoryPb_proto_rawDesc = "" +
	...
	"\x06itemId\x18\x02 \x01(\x05R\x06itemId\"8\n" +
	"\x14IsAvailableToSellRes\x12 \n" +
	"\visAvailable\x18\x01 \x01(\bR\visAvailable2Y\n" +
	"\x14InventoryGrpcService\x12A\n" +
	"\x11IsAvailableToSell\x12\x15.IsAvailableToSellReq\x1a\x15.IsAvailableToSellResB\"Z github.com/Supakornn/mmorpg-shopb\x06proto3"
